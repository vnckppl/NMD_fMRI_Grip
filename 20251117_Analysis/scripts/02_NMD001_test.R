...
sub <- "sub-NMD001"
idir <- file.path(base, "fMRIPrep_25.2.3", sub, "ses-01/func")
odir <- file.path(base, "20251117_1stlevel", sub)
...
## ** Export cifti file
ofile_cii <- file.path(odir_b, paste0(sub, "_bglm_1st_level.func.nii"))
write_cifti(
