...
- I am only writing out the processed data in voxel-wise MNI space in 91k surface space (fsLR) data.
- I am not writing out the data in native functional voxel space (=--output-spaces func=) or in freesurfer average surface space (=--output-spaces fsaverage:den-10k=).
...
wdir="${base}/20230809_Kladblok/20251114_NMD_fMRI/20251116_MRIQC/scripts/work"
mkdir -p "${odir}"
