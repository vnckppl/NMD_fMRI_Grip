...
## * Export results to cifti, gifti, and nifti files
# Had some error here with writing out. Have contacted Damon:
# "So the activations result does have NA values in the left and right cortex. I
# wonder if the explanation is simply that the BayesfMRI result had NA
# locations, like from the data being NA or low-variance. One quick solution is
# to change those values to 0, which corresponds to the un-activated label. But
# if you want to preserve a separation of the NA values, you could define a new
# label like what the error message is suggesting"
replace_NA_with_label <- function(xii, NA_value=-1, NA_label="NA", NA_color="#FFFFFFFF") {
